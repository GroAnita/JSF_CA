    ...
    return (
        <main className="p-4">
            ...
            <div className="flex flex-col gap-4">
                {items.map((item) => (
                    <div key={item.product.id} className="flex flex-row gap-4 items-center border-b border-gray-200 pb-4">
                        <Image
                        ...
                        <div className="flex flex-col flex-1">
                            ...
                            <p className="text-gray-800 font-medium">NOK{item.product.discountedPrice}</p>
            ...
            <div className="mt-6 flex flex-col items-end gap-4">
                <p className="text-xl font-bold text-gray-800">Total: NOK{total.toFixed(2)}</p>
